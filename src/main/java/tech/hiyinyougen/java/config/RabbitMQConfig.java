...
public class RabbitMQConfig {
     ...
     * 连接名称
     */
    private static final String CONNECTIONFACTORYNAME = "javaConnectionFactory";

    /**
     * 交换器
     */
    public static final String JAVA_EXCHANGE = "java_exchange";
    ...
    private static final String LISTENERCONTAINERFACTORY = "javaFactory";
